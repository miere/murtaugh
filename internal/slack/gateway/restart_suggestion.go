...
func (a *Gateway) resolveSuggestionDestination(ctx context.Context, channel string) (string, error) {
	if channel != "" {
		return channel, nil
	}
...
func (a *Gateway) handleRestartSuggestionInteraction(ctx context.Context, interaction slack.InteractionCallback) {
...
func (a *Gateway) editSuggestion(ctx context.Context, channel, ts, text string) {
