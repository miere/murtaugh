...
func (a *App) postRestartNoticeAndSaveMarker(ctx context.Context, channel, threadTS, userID, source, reason string) {
...
func (a *App) consumeResumeMarker(ctx context.Context) {
